...
df <- readRDS(file = "scripts/spotify_data.rds")
source("scripts/spotify_tables.R")
```
...
```{r}
df.daily <- read.csv("scripts/us-daily-2022-02-23.csv")
...
```{r}
source("scripts/playlistMoods.R")
