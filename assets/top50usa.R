...
#pl <- get_playlist('37i9dQZEVXbLp5XoPON0wI?si=1d64e2ea854e469a&nd=1')
pl <- get_playlist('37i9dQZEVXbLRQDuF5jeBp?si=c476a49ba67f498a')
...
top50USA <- get_playlist("37i9dQZEVXbLp5XoPON0wI?si=1d64e2ea854e469a&nd=1")

topTracks <- get_playlist_tracks(playlist_id = "37i9dQZEVXbLp5XoPON0wI")
...
## GET PLAYLIST GENRES
pl <- get_playlist('0rHe1rlPP1uPs8NpjnCeXU')
tr <- pl$tracks
tr_items <- tr$items
...
pl_list <- pl_list[, c('artist.names', 
                       'track.name', 
                       'track.album.name', 
                       'track.id', 
                       'artist.id')]
...
artist_id_list <- unlist(artist_id)
total_artist_list <- rbind(get_artists(artist_id_list[1:50]), 
                           get_artists(artist_id_list[51:55]))
genre_list <- unlist(total_artist_list$genres)
